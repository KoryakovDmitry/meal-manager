...
- **Cooking lifecycle**: `register_cooked_meal` consumes essential inventory/prep while preserving the linked plan row and transitioning it from `planned` to `cooked`. Plan/history/inventory/prep are one audited recovery-safe command.
