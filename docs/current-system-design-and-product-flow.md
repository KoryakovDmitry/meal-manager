...
| Файл | Назначение |
|---|---|
| `data/fridge.json` | versioned inventory/catalog envelope, schema v6 (aliases + internal stock cycle) |
...
- recipe catalog;
- structured inventory schema v6 with generic aliases and missing-stock occurrence cycles;
